...
Добавление: По одному случайному элементу после каждого отрицательного элемента 
Перестановка:Положительные  элементы переставить в начало  массива, отрицательные   - в конец
Поиск: Занулить последний отрицательный элемент 
*/
